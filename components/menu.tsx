    ...
    <div className="flex flex-col">
      <div className="flex flex-col ">
        ...
        <button className="border-black border mt-2">
          ...
          <div style={{ fontSize: '0.7rem' }}>다시보기</div>
        </button>
        <button className="border-black border mt-2">
          <span
            className="material-symbols-outlined"
          ...
          <div style={{ fontSize: '0.7rem' }}>카테고리</div>
        </button>
        <button className="border-black border mt-2">
          <span
            className="material-symbols-outlined"
          ...
          <div style={{ fontSize: '0.7rem' }}>팔로잉</div>
        </button>
      </div>
      <div style={{ fontSize: '0.9rem' }}>추천</div>
      <div style={{ fontSize: '0.9rem' }}>파트너</div>
      <div className="divide-x divide-solid border-white border"></div>
